...
def set_table(gender : int) -> dict:
    ...
    if gender == 0:
        ...
        man[(5, 0)] = [[6, 7], [3, 6]]
        man[(5, 1)] = man[(5, 2)] = man[(5, 3)] = man[(5, 4)] = [[2, 5, 7], [4, 6]]
        man[(5, 5)] = [[0], [0]]

        man[(6, 0)] = man[(6, 1)] = [[1, 2], [2, 3, 6]]
        man[(6, 2)] = [[1, 2], [4]]
        man[(6, 3)] = man[(6, 4)] = [[1, 2], [1]]
        man[(6, 4)] = [[0], [0]]

        man[(7, 0)] = man[(7, 1)] = man[(7, 2)] = man[(7, 4)] = [[1, 7], [1, 3, 5, 7, 8]]
        man[(7, 3)] = [[1, 2], [5]]
        man[(7, 5)] = [[0], [0]]

        man[(8, 0)]  = man[(8, 1)]  = man[(8, 2)]  = man[(8, 3)]  = man[(8, 4)] = [[1, 7], [5, 7, 8]]
        man[(8, 5)] = [[0], [0]]
